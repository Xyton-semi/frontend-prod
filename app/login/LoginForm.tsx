  ...
  return (
    <div className="w-full max-h-full overflow-y-auto p-6 sm:p-8">
      ...
      <div className="text-center mb-6">  
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-red-950 rounded-full mb-3">
          <LogIn size={24} className="text-red-600 sm:w-7 sm:h-7" />
        </div>
        <h1 className="text-xl sm:text-2xl font-semibold text-white mb-1">Sign In</h1>
        <p className="text-xs sm:text-sm text-gray-400">Welcome back! Sign in to continue</p>
      </div>
      ...
      {submitStatus === 'success' && (
        <div className="mb-4 p-3 bg-green-950 border border-green-800 rounded-lg flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-green-400 mt-0.5">Taking you to your workspace...</p>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 text-smtext-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-colors ${
              errors.email 
        ...
        <button
          ...
          className="w-full py-2.5 px-4 bg-red-800 hover:bg-red-700 text-white text-sm font-medium rounded-lg disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors flex items-center justify-center space-x-2"
        >
          {isSubmitting ? (
            <>
