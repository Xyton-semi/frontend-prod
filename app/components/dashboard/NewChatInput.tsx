      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
        ...
        <div className="relative flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 border border-gray-800 px-4 py-3 bg-black text-white rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] max-h-[200px] font-sans text-sm"
